...
%	\vspace{-0.4cm}
	...
	I recently graduated with a bachelor's degree in Computer Science and I am currently an instructor of Data Structures and Algorithms in the Computer Science program at the University of Havana. I have an strong inclination for Mathematics and I am currently working on my application to graduate school in mathematics. My main research interest is algebra with emphasis on the atomic structure of commutative rings and monoids. During the past 4 years, I have been conducting research in factorization theory under the supervision of Felix Gotti.
...
\section{Teaching Experience}
	...
	\begin{tabularx}{0.97\linewidth}{>{\raggedleft\scshape}p{2cm}X}
		...
		\gray Topics & \textbf{Introduction to Programming with Python}\\
